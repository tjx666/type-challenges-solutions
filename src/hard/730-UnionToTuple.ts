...
type UnionToIntersection<U, E = U> = (E extends U ? (x: E) => unknown : never) extends (
    x: infer I,
) => unknown
    ? I
    : never;
type R1 = UnionToIntersection<{ a: number } | { b: number }>;
